...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(translate, router, token) {
        var _this = this;
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        console.log("dashboard is :" + this.currentUser);
    };
    ...
    HeaderComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _auth_token_storage_service__WEBPACK_IMPORTED_MODULE_3__["TokenStorageService"]])
    ], HeaderComponent);
...
var SidebarComponent = /** @class */ (function () {
    function SidebarComponent(translate, router, token) {
        var _this = this;
        this.translate = translate;
        this.router = router;
        this.token = token;
    ...
    SidebarComponent.prototype.addExpandClassAdmin = function (element) {
        if (element === this.showMenu) {
            this.showMenu = '0';
        }
        else {
...
var routes = [
    {
        ...
        children: [
            ...
            { path: 'walkins', loadChildren: './form/admin/walkins/walkins.module#WalkinsModule' },
            { path: 'registration', loadChildren: './form/admin/registration/registration.module#RegistrationModule' },
            { path: 'visits', loadChildren: './form/admin/visits/visits.module#VisitsModule' },
            { path: 'edit-user', loadChildren: './form/admin/registration-details/registration-details.module#RegistrationDetailsModule' },
            { path: 'registration-worklist', loadChildren: './form/admin/registration-worklist/registration-worklist.module#GridMaterialModule' }
        ]
    }
];
