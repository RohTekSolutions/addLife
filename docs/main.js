...
var map = {
	...
	"./form/admin/registration-details/registration-details.module": [
		"./src/app/layout/form/admin/registration-details/registration-details.module.ts",
		"form-admin-registration-details-registration-details-module~form-admin-registration-registration-mod~d625972e",
		"form-admin-registration-details-registration-details-module~form-form-module",
		"common",
		"form-admin-registration-details-registration-details-module"
	],
	"./form/admin/registration-worklist/registration-worklist.module": [
		"./src/app/layout/form/admin/registration-worklist/registration-worklist.module.ts",
		"form-admin-registration-details-registration-details-module~form-admin-registration-registration-mod~d625972e",
		"form-admin-registration-worklist-registration-worklist-module~form-admin-visits-visits-module",
		"common",
		"form-admin-registration-worklist-registration-worklist-module"
	],
	"./form/admin/registration/registration.module": [
		"./src/app/layout/form/admin/registration/registration.module.ts",
		"form-admin-registration-details-registration-details-module~form-admin-registration-registration-mod~d625972e",
		"common",
		"form-admin-registration-registration-module"
	],
	"./form/admin/visits/visits.module": [
		"./src/app/layout/form/admin/visits/visits.module.ts",
		"form-admin-registration-worklist-registration-worklist-module~form-admin-visits-visits-module",
		"common",
		"form-admin-visits-visits-module"
	],
	"./form/admin/walkins/walkins.module": [
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [_shared__WEBPACK_IMPORTED_MODULE_9__["AuthGuard"], _auth_auth_interceptor__WEBPACK_IMPORTED_MODULE_11__["httpInterceptorProviders"]],
...
module.exports = __webpack_require__(/*! D:\GITLAB\AddLife\Deploy\addlife_frontlayer\src\main.ts */"./src/main.ts");
